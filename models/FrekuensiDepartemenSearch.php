...
use app\models\FrekuensiDepartemen;

/**
 * SampelSearch represents the model behind the search form about `app\models\Sampel`.
 */
class FrekuensiDepartemenSearch extends FrekuensiDepartemen
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['nama_fakultas','nama_departemen','jumlah'], 'safe'],
        ];
    }
    ...
    {
        $query = FrekuensiDepartemen::find();
